...
*AppApi* | [**AutoScaleSwap**](docs/AppApi.md#autoscaleswap) | **Post** /1.29/apps/{app}/units/autoscale/swap | 
...
## Documentation For Models
 ...
 - [Event](docs/Event.md)
 - [EventAllowedPermission](docs/EventAllowedPermission.md)
 - [EventCancelArgs](docs/EventCancelArgs.md)
 - [EventCancelInfo](docs/EventCancelInfo.md)
 - [EventCustomData](docs/EventCustomData.md)
 - [EventCustomDataRaw](docs/EventCustomDataRaw.md)
 - [EventExtraTarget](docs/EventExtraTarget.md)
 - [EventKind](docs/EventKind.md)
 - [EventLogEntry](docs/EventLogEntry.md)
 - [EventOwner](docs/EventOwner.md)
 - [EventPermissionContext](docs/EventPermissionContext.md)
 - [EventTarget](docs/EventTarget.md)
 - [EventTrackedInstance](docs/EventTrackedInstance.md)
 ...
 - [SwapAutoScaleSpec](docs/SwapAutoScaleSpec.md)
 - [Team](docs/Team.md)
