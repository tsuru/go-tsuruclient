 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param app App name.
 * @param optional nil or *AppLogOpts - Optional Parameters:
 * @param "Lines" (optional.String) -  Number of log lines to retrieve.
 * @param "Source" (optional.String) -  Filter logs by source.
 * @param "Unit" (optional.String) -  Filter logs by unit.
@return []AppLog
*/
...
func (a *AppApiService) AppLog(ctx context.Context, app string, localVarOptionals *AppLogOpts) ([]AppLog, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []AppLog
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0/apps/{app}/log"
	localVarPath = strings.Replace(localVarPath, "{"+"app"+"}", fmt.Sprintf("%v", app), -1)
	...
	if localVarOptionals != nil && localVarOptionals.Lines.IsSet() {
		localVarQueryParams.Add("lines", parameterToString(localVarOptionals.Lines.Value(), ""))
	}
...
Set the certificate issuer for the app.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param app Application name
  - @param certIssuerSetData
*/
func (a *AppApiService) AppSetCertIssuer(ctx context.Context, app string, certIssuerSetData CertIssuerSetData) (*http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Put")
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.24/apps/{app}/certissuer"
	localVarPath = strings.Replace(localVarPath, "{"+"app"+"}", fmt.Sprintf("%v", app), -1)
	...
	// body params
	localVarPostBody = &certIssuerSetData
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
Unset the certificate issuer for the app.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param app Application name
  - @param cname Certificate CNAME
*/
func (a *AppApiService) AppUnsetCertIssuer(ctx context.Context, app string, cname string) (*http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Delete")
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarQueryParams.Add("cname", parameterToString(cname, ""))
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
Swap autoscale to another version.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param app App name.
  - @param swapAutoScaleSpec
*/
func (a *AppApiService) AutoScaleSwap(ctx context.Context, app string, swapAutoScaleSpec SwapAutoScaleSpec) (*http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.29/apps/{app}/units/autoscale/swap"
	localVarPath = strings.Replace(localVarPath, "{"+"app"+"}", fmt.Sprintf("%v", app), -1)
	...
	// body params
	localVarPostBody = &swapAutoScaleSpec
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
